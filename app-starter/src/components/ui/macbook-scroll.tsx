...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 1], [0, isMobile ? 2000: 500]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.5] sm:scale-100"
    >
      <motion.h2
        style={{
